...
const I18N = {
  ru: {
    ...
    'about.text': 'АО «Центр цифрового развития НБК» — лидер цифровой трансформации. Более 25 лет обеспечиваем Национальный Банк передовыми ИТ-решениями. Заглушка — заполнить позже.',
    'about.board': 'Совет директоров', 'about.p.name': 'Имя Фамилия',
    'about.p1role': 'Председатель — заглушка', 'about.prole': 'Член совета — заглушка',
    'news.tag': 'Новости · ЦЦР', 'news.title': 'Новости',
    'news.n1t': 'Заголовок новости 1', 'news.n2t': 'Заголовок новости 2', 'news.n3t': 'Заголовок новости 3',
    'news.n4t': 'Заголовок новости 4', 'news.n5t': 'Заголовок новости 5', 'news.n6t': 'Заголовок новости 6',
    'news.n1d': 'Полный текст новости — заглушка. Здесь будет описание события, которое раскрывается при наведении или нажатии на карточку.',
    'news.nd': 'Полный текст новости — заглушка. Раскрывается по наведению / клику.',
  ...
  kk: {
    ...
    'about.text': '«ҰБ Цифрлық даму орталығы» АҚ — цифрлық трансформация көшбасшысы. 25 жылдан астам уақыт Ұлттық Банкті озық IT-шешімдермен қамтамасыз етеміз. Толтыру қажет.',
    'about.board': 'Директорлар кеңесі', 'about.p.name': 'Аты-жөні',
    'about.p1role': 'Төраға — толтыру қажет', 'about.prole': 'Кеңес мүшесі — толтыру қажет',
    'news.tag': 'Жаңалықтар · ЦДО', 'news.title': 'Жаңалықтар',
    'news.n1t': 'Жаңалық тақырыбы 1', 'news.n2t': 'Жаңалық тақырыбы 2', 'news.n3t': 'Жаңалық тақырыбы 3',
    'news.n4t': 'Жаңалық тақырыбы 4', 'news.n5t': 'Жаңалық тақырыбы 5', 'news.n6t': 'Жаңалық тақырыбы 6',
    'news.n1d': 'Жаңалықтың толық мәтіні — толтыру қажет. Мұнда картаны меңзегенде немесе басқанда ашылатын оқиға сипаттамасы болады.',
    'news.nd': 'Жаңалықтың толық мәтіні — толтыру қажет. Меңзеу / басу арқылы ашылады.',
  ...
  en: {
    ...
    'about.text': '“DDC of the NBK” JSC is a leader in digital transformation. For over 25 years we have provided the National Bank with advanced IT solutions. Placeholder — to be filled in later.',
    'about.board': 'Board of Directors', 'about.p.name': 'Full Name',
    'about.p1role': 'Chairman — placeholder', 'about.prole': 'Board member — placeholder',
    'news.tag': 'News · DDC', 'news.title': 'News',
    'news.n1t': 'News headline 1', 'news.n2t': 'News headline 2', 'news.n3t': 'News headline 3',
    'news.n4t': 'News headline 4', 'news.n5t': 'News headline 5', 'news.n6t': 'News headline 6',
    'news.n1d': 'Full news text — placeholder. A description of the event will appear here, expanding on hover or tap.',
    'news.nd': 'Full news text — placeholder. Expands on hover / click.',
